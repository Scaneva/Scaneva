#region Copyright (C)
// ---------------------------------------------------------------------------------------------------------------
//  <copyright file="LinearSweepVoltammetryExperiment.cs" company="Scaneva">
// 
...
{
    [Category("PalmSens")]
    public class PS_LinearSweepVoltammetry : ExperimentBase, IExperiment
    {
        public PS_LinearSweepVoltammetry(LogHelper log)
            : base(log)
        {
            settings = new PS_LinearSweepVoltammetrySettings();
        }

        public PS_LinearSweepVoltammetrySettings Settings
        {
            get
            {
                return (PS_LinearSweepVoltammetrySettings)settings;
            }
            set
            {
                settings = value;
        ...
        private LinearSweep lsv = new LinearSweep();
        ...
        public override enExperimentStatus Configure(IExperiment parent, string resultsFilePath)
        {
            ...
            ResultsFileName = "LinearSweepVoltammetryExperiment - " + Name + cords + ".dat";
        ...
        public override void ParameterChanged(string name)
        {
            ...
            switch (name)
            {
                ...
                case "Linear Sweep Voltammetry.PalmSens HW Name":
                    refreshCurrentRanges();
                    break;
